...
public class Pattern_E7 : MonoBehaviour
{
    ...
    private IEnumerator IE_Pattern()
    {
        ...
        subPatternsTF[0].position = new Vector3(PlayerTF.position.x + 1, Center.position.y, Center.position.z);
        subPatterns[0].PlaySubPattern();
        subPatternsTF[1].position = new Vector3(PlayerTF.position.x - 1, Center.position.y, Center.position.z);
